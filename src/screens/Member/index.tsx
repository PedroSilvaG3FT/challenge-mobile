...
const Member: React.FC = () => {
  ...
  const [remainingGoalWeek, setRemainingGoalWeek] = useState<
    number | undefined
  >(0);
  const [remainingGoalWeight, setRemainingGoalWeight] = useState<
    number | undefined
  >(0);
  ...
  async function getUserInfo() {
    ...
    userService.getById(storagedUser.id as number).then(
      (response) => {
        ...
        const goalWeight = res.goalWeight
          ? res.currentWeight - res.goalWeight
          : 0;
          ...
          <View style={styles.header}>
            ...
            <View style={{ ...styles.centerAlignItems, flex: 1 }}>
              ...
              <Text style={styles.userInfoLabel}>
                Olá {user?.name?.split(" ")[0]}, o seu peso atual é
              </Text>
            ...
            {isChallenge && (
              <View style={styles.centerAlignItems}>
                <Text style={[styles.goalText, { color: Colors.colorDanger }]}>
                  Meta
                </Text>
                <Text>(Final)</Text>
                <Text style={styles.goalWeight}>
