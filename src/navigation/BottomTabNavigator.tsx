...
import {
  BottomTabParamList,
  TabMemberGroupParamList,
  TabMemberParamList,
  TabSettingsParamList,
  TabTipsNewsParamList,
} from "../../types";
    ...
    >
      <BottomTab.Screen
        ...
        options={{
          tabBarLabel: "Eu",
          tabBarIcon: ({ color }) => (
            <Icon name="user" size={sizeIconDefault} color={color} />
          ),
        }}
      />
      <BottomTab.Screen
        ...
        options={{
          tabBarLabel: "Grupo",
          tabBarIcon: ({ color }) => (
            <Icon name="users" size={sizeIconDefault} color={color} />
          ),
        }}
      />
      {/* <BottomTab.Screen
      ...
      <BottomTab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color }) => (
            <Icon name="list" size={sizeIconDefault} color={color} />
          ),
        }}
      />
    </BottomTab.Navigator>
